...
const Subject_1 = require("./CourseInfo/Subject");
const Course_1 = require("./CourseInfo/Course");
const Section_1 = require("./CourseInfo/Section");
...
rp(UBCCourses)
    ...
    subjects.each(function () {
        ...
        // console.log(faculty);
        let subject = new Subject_1.Subject(code, link, title, faculty);
    ...
    for (let promise of promises) {
        ...
        subjects.each(function (i, elem) {
            ...
            let course = new Course_1.Course(course_td_a_text, course_td_title, course_td_a_href);
    ...
    for (let promise of sectionPromises) {
        ...
        subjects.each(function (i, elem) {
            ...
            let section = new Section_1.Section(status, curr_section, href, activity, term, interval, days, start, end, comments);
